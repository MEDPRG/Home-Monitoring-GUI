...
import com.demotique.swing.shadow.ShadowRenderer;
...
public class ButtonMenu extends JButton {
    ...
    public void setIconName(String iconName) {
        ...
        setIcon(new ImageIcon(getClass().getResource("/com/demotique/icon/" + iconName + ".png")));
    }
    ...
    public void setSelected(boolean bln) {
        ...
        if (bln) {
            setIcon(new ImageIcon(getClass().getResource("/com/demotique/icon/" + iconName + "s.png")));
